...
def handle_networking_scan(scanner_id, scanned_user_id, scan_method):
    ...
    try:
        ...
        connection_sql = \"\"\"
            ...
            VALUES (%s, %s, %s, NOW())
        \"\"\"
        db.execute_query(connection_sql, (scanner_id, scanned_user_id, scan_method))
        ...
        log_sql = \"\"\"
            ...
            VALUES (%s, %s, %s, NOW())
        \"\"\"
        db.execute_query(log_sql, (scanner_id, scanned_user_id, scan_method))
        ...
        \"\"\"
        db.execute_query(notif_sql, (scanned_user_id, f'New connection via {scan_method.upper()}'))
...
def handle_checkin_scan(event_id, attendee_id, admin_id, scan_method):
    ...
    try:
        ...
        \"\"\"
        current_checkin = db.execute_query(checkin_sql, (event_id, attendee_id), fetch=True, fetchone=True)
        ...
        if not current_checkin or current_checkin['checked_out_at']:
            ...
            insert_checkin = \"\"\"
                ...
                VALUES (%s, %s, NOW(), %s, %s)
            \"\"\"
            db.execute_query(insert_checkin, (event_id, attendee_id, admin_id, scan_method))
            ...
            update_checkout = \"\"\"
                ...
                WHERE id = %s
            \"\"\"
            db.execute_query(update_checkout, (admin_id, current_checkin['id']))
        ...
        \"\"\"
        db.execute_query(log_admin, (event_id, admin_id, attendee_id, action_taken, scan_method))
...
def get_event_checkin_stats(event_id):
    ...
    \"\"\"
    checked_in = db.execute_query(checked_in_sql, (event_id,), fetch=True, fetchone=True)['count']
    ...
    \"\"\"
    total_checkins_today = db.execute_query(today_sql, (event_id,), fetch=True, fetchone=True)['count']
...
def api_checkin_log(event_id):
    ...
    try:
        ...
        log_sql = \"\"\"
            ...
            LIMIT 50
        \"\"\"
        checkins = db.execute_query(log_sql, (event_id,), fetch=True)
...
def my_connections():
    ...
    \"\"\"
    connections = db.execute_query(conn_sql, (user_id, user_id, user_id, user_id), fetch=True)
