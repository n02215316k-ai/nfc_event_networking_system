...
def inject_common_data():
    ...
    if 'user_id' in session:
        ...
        unread_messages_result = execute_query('''
        ...
        unread_notifications_result = execute_query('''
...
def index():
    ...
    stats = {
        ...
        'my_registrations': execute_query(
            "SELECT COUNT(*) as count FROM attendance WHERE user_id = %s",
            (session['user_id'],),
            fetch=True, fetchone=True
        )['count'],
        
        'my_forums': execute_query(
